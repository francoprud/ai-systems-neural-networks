...
% betha:
function output = multilayer_perceptron_batch(trainingSet, testingSet, layersAndSize, minimumError, learingRate, activation_func, activation_func_derived, betha, alpha, adaptativeA, adaptativeB, kEpochs)
